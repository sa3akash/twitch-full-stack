...
export type LoginMutation = { __typename?: 'Mutation', login: { __typename?: 'AuthModel', message?: string | null, user?: { __typename?: 'UserModel', username: string } | null } };
...
export type ClearSessionCookieMutation = { __typename?: 'Mutation', clearSessionsCookie: boolean };
...
export type FindNotificationsByUserQuery = { __typename?: 'Query', findNotificationsByUser: Array<{ __typename?: 'NotificationModel', id: string, isRead: boolean, message: string, type: NotificationType, createdAt: any }> };
