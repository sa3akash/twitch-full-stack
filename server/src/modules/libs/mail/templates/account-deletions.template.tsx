		        ...
		        <Body className='max-w-2xl mx-auto p-6 bg-slate-50'>
					<Section className="text-center">
						...
						<Text className="text-base text-black mt-2">
							Your account has been fully removed from SA2Stream's database. All your data and information have been permanently deleted.
						</Text>
					</Section>

					<Section className="bg-white text-black text-center rounded-lg shadow-md p-6 mb-4">
						<Text>
							You will no longer receive notifications via Telegram and email.
						</Text>
						<Text>
